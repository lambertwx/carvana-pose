...
if False:
    ...
    lay = Dense(16)(lay)                        # This is the new dense layer I'm adding for expt05
    lay = Activation('relu')(lay)   
    lay = Dropout(.20)(lay)
...
#%%
    ...
    #%%  Build the model
    modf.compile(optimizer=SGD(.01), loss='categorical_crossentropy', 
             metrics =['categorical_crossentropy', 'categorical_accuracy'] )
    callbacks = [EarlyStopping(monitor='val_categorical_accuracy', patience=5, verbose=1, mode='max'),
                 ModelCheckpoint('expt05_epoch{epoch:02d}.h5', monitor='val_categorical_accuracy', verbose=1, 
